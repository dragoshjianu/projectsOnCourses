...
(function () {
	...
	var validate_field = function (elem, remove) {
		...
		if (elem.getAttribute('required') !== null) {
			if (
				...
				if (!no_error) {
					tooltip = create_tooltip(elem, 'Alege o varianta.');
				}
				...
				elem.className = elem.className + ' _has_error';
				no_error = false;
				tooltip = create_tooltip(elem, 'Camp obligatoriu.');
			}
		}
	...
	var form_submit = function (e) {
		...
		if (validate_form()) {
			...
			var serialized = _form_serialize(document.getElementById('_form_3_')).replace(
				/%0A/g,
				'\\n'
			);
			var err = form_to_submit.querySelector('._form_error');
			...
			_load_script(
				'https://dragoshjianu25340.activehosted.com/proc.php?' +
					serialized +
					'&jsonp=true',
				null,
				true
